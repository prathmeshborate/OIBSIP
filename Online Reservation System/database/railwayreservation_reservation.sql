...
CREATE TABLE `reservation` (
  ...
  `DateOfJourney` varchar(50) DEFAULT NULL,
  `NoOfPassengers` varchar(50) DEFAULT NULL,
  `FromStation` varchar(50) DEFAULT NULL,
  `ToStation` varchar(50) DEFAULT NULL,
  `Ammount` varchar(50) DEFAULT NULL
...
-- Dump completed on 2023-09-19 22:02:25
